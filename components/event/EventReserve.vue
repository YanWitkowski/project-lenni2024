          ...
          <div class="reserve__scheme">
            <div class="reserve__scheme-container">
              ...
              <div class="reserve__scheme-wrapper">
                ...
                <div class="reserve__scheme-wrapper">
                  <svg class="reserve__scene scene" width="780" height="399" viewBox="0 0 780 399" fill="none" xmlns="http://www.w3.org/2000/svg" id="js-reserveScene">
                    ...
                    <g class="scene__table scene__table--red js-sceneTable" id="table_1" data-check="table_1">
                      ...
                      <path class="scene__table-num" d="M552.199 56H548.283V48.4414C548.283 47.5234 548.303 46.6836 548.342 45.9219C548.101 46.2148 547.801 46.5208 547.443 46.8398L545.822 48.1777L543.82 45.7168L548.723 41.7227H552.199V56Z" fill="#BC3324" />
                      <rect x="507" y="8" width="111" height="83" fill="transparent" />
                    </g>

                    <g class="scene__table js-sceneTable" id="table_2" data-check="table_2">
                    ...
                    <g class="scene__table js-sceneTable" id="table_3" data-check="table_3">
                      <g class="scene__table-group" stroke="#1F1E1E">
                    ...
                    <g class="scene__table js-sceneTable" id="table_4" data-check="table_4">
                      <g class="scene__table-group" stroke="#BC3324">
                        <rect x="507.5" y="185.5" width="83" height="28" />
                        <circle cx="527" cy="167" r="11.5" />
                        <circle cx="570" cy="167" r="11.5" />
                        <circle cx="606" cy="195" r="11.5" />
                        <circle cx="570" cy="230" r="11.5" />
                        <circle cx="527" cy="230" r="11.5" />
                      </g>
                    ...
                    <g class="scene__table js-sceneTable">
                    ...
                    <g class="scene__table js-sceneTable" id="table_6" data-check="table_6">
                      <g class="scene__table-group" stroke="#1F1E1E">
                    ...
                    <g class="scene__table js-sceneTable" id="table_7" data-check="table_7">
                      <g class="scene__table-group" stroke="#BC3324">
                        <rect x="320.5" y="183.5" width="83" height="28" />
                        <circle cx="383" cy="227" r="12" />
                        <circle cx="419" cy="197" r="12" />
                        <circle cx="305" cy="197" r="12" />
                        <circle cx="340" cy="227" r="12" />
                      </g>
                      <path class="scene__table-num" d="M358.041 204L362.943 192.936H356.762V189.742H367.064V192.018L362.035 204H358.041Z" fill="#BC3324" />
                      <rect x="293" y="183" width="138" height="56" fill="transparent" />
                    </g>

                    <g class="scene__table js-sceneTable" id="table_8" data-check="table_8">
                      <g class="scene__table-group" stroke="#BC3324">
                    ...
                    <g class="scene__table js-sceneTable" id="table_10" data-check="table_10">
                      <g class="scene__table-group" stroke="#1F1E1E">
                        <path d="M110.5 65V0.5H141.5V64.8261V92.5H15.5V65.5H110H110.5V65Z" />
                        <circle cx="27" cy="50" r="12" />
                        <circle cx="61" cy="50" r="12" />
                        <circle cx="94" cy="50" r="12" />
                        <circle cx="94" cy="16" r="12" />
                      </g>

                      <path class="scene__table-num" d="M121.199 85H117.283V77.4414C117.283 76.5234 117.303 75.6836 117.342 74.9219C117.101 75.2148 116.801 75.5208 116.443 75.8398L114.822 77.1777L112.82 74.7168L117.723 70.7227H121.199V85ZM134.734 77.8809C134.734 80.4069 134.311 82.2591 133.465 83.4375C132.618 84.6094 131.323 85.1953 129.578 85.1953C127.872 85.1953 126.587 84.5833 125.721 83.3594C124.855 82.1289 124.422 80.3027 124.422 77.8809C124.422 75.3418 124.845 73.4798 125.691 72.2949C126.538 71.11 127.833 70.5176 129.578 70.5176C131.277 70.5176 132.56 71.1361 133.426 72.373C134.298 73.6035 134.734 75.4395 134.734 77.8809ZM128.26 77.8809C128.26 79.4954 128.361 80.6055 128.562 81.2109C128.764 81.8164 129.103 82.1191 129.578 82.1191C130.06 82.1191 130.398 81.8066 130.594 81.1816C130.796 80.5566 130.896 79.4564 130.896 77.8809C130.896 76.2988 130.796 75.1921 130.594 74.5605C130.392 73.9225 130.053 73.6035 129.578 73.6035C129.103 73.6035 128.764 73.9095 128.562 74.5215C128.361 75.1335 128.26 76.2533 128.26 77.8809Z" fill="#1F1E1E" />
                      <rect x="15" width="127" height="93" fill="transparent" />
                    </g>

                    <g class="scene__table js-sceneTable" id="table_11" data-check="table_11">
                      <g class="scene__table-group" stroke="#1F1E1E">
