<template>
<div v-if="isActive" class="pp" id="js-eventPP">
    <div class="pp__container">
        <div class="pp__sticky-close">
            <button type="button" class="pp__sticky-btn js-ppCloseBtn" @click="closeEventPP">
                        ...
                        <div class="form__field field js-dateField">
                            ...
                            <div class="field__date">
                                <div class="field__date-inputs">
                                    ...
                                    <input class="field__date-input js-dateMonth" type="text" placeholder="ММ"
                                        readonly />
                                    <input class="field__date-input field__date-input--year js-dateYear" type="text"
                                        placeholder="ГГГГ" readonly />
                                </div>
                                <input class="field__date-picker js-dateInput" type="text" name="date" readonly
                                    required />
                            </div>
                        </div>
                    </div>
                    <div class="form__section">
                        ...
                        <div class="form__list form__list--mb50">
                            ...
                            <label class="form__field form__field--w50 field">
                                ...
                                <input type="text" class="field__input" placeholder="Фамилия" name="last_name"
                                    required />
                            </label>
                            <label class="form__field form__field--w50 field">
                                <span class="field__label">
                                ...
                                <input type="tel" class="field__input js-mobileMask" placeholder="Телефон" name="phone"
                                    required />
                            </label>
                            <label class="form__field form__field--w50 field">
                                <span class="field__label">
                        ...
                        <label class="form__check form__check--mb40 check field">
                        ...
                        <div class="form__btn-block">
                            ...
                            <button type="close" class="form__btn form__btn--close js-ppCloseBtn" @click="closeEventPP">
                                Закрыть
                            </button>
                        </div>
                    </div>
...
const isActive = computed(() => {
    return store.modal.eventPP;
});

const closeEventPP = () => {
    store.modal.eventPP = false;
};
</script>
